...
function KaringtonyExpress({ rows, stats, allPreds, nextMatch, currentStage, playerCount }) {
  ...
  const ed = buildEdition({ rows, stats, allPreds, nextMatch, currentStage })
  const dateStr = format(new Date(), 'EEEE, d MMMM yyyy', { locale: pl })
